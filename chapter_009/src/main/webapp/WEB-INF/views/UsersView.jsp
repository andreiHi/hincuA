...
<h2 align="center"><form  action="<%=request.getContextPath()%>/forward" method="post">
<input type="submit" name="new" value="Добавить нового пользователя">
</form></h2>
<%--<h2 align="center"><a href="<%=request.getContextPath()%>/WEB-INF/views/UserForm.jsp" name="new">Добавить нового пользователя</a></h2>--%>
